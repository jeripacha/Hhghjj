const areas = {
  pacha: [
    { name: "ignacio aguilar", quantity: "980", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "pacha 1" },
    { name: "ignacio aguilar", quantity: "980", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "pacha 2" },
    { name: "pacha sunset", quantity: "980", drinks: "parrales,gin republica", combos: "cumpleañero", mesa: "pacha 3" },
    { name: "pacha sunset", quantity: "980", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "pacha 4" },
    { name: "pacha sunset", quantity: "930", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "pacha 5" },
    { name: "pacha sunset", quantity: "750", drinks: "parrales,FDC5", combos: "cascabel", mesa: "pacha 6" },
    { name: "pacha sunset", quantity: "980", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "pacha 7" },
    { name: "ignacio aguilar", quantity: "980", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "pacha 8" },
    { name: "ignacio aguilar", quantity: "980", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "pacha 9" },
    { name: "", quantity: "", drinks: "", combos: "", mesa: "pacha 10" },
  ],

  lounge: [
    { name: "mama", quantity: "1000", drinks: "parrales", combos: "pachamama", mesa: "lounge 1" },
    { name: "pacha sunset", quantity: "1000", drinks: "parrales", combos: "pachamama", mesa: "lounge 2" },
    { name: "pacha sunset", quantity: "1200", drinks: "parrales, vodka", combos: "pachamama", mesa: "lounge 3" },
    { name: "pacha sunset", quantity: "1130", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "lounge 4" },
    { name: "pacha sunset", quantity: "800", drinks: "parrales,FDC5", combos: "cascabel", mesa: "lounge 5" },
    { name: "pacha sunset", quantity: "700", drinks: "jager", combos: "jager", mesa: "lounge 6" },
    { name: "pacha sunset", quantity: "900", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "lounge 7" },
    { name: "pacha sunset", quantity: "500", drinks: "parrales", combos: "banx", mesa: "lounge 8" },
    { name: "pacha sunset", quantity: "800", drinks: "parrales,FDC5", combos: "cascabel", mesa: "lounge 9" },
    { name: "pacha sunset", quantity: "930", drinks: "parrales, vodka", combos: "cumpleañero", mesa: "lounge 10" },
    { name: "pacha sunset", quantity: "700", drinks: "jager", combos: "jager", mesa: "lounge 11" },
  ],

  parrales: [
    { name: "pacha sunset", quantity: "930", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "parrales 1" },
    { name: "pacha sunset", quantity: "900", drinks: "parrales, parrales", combos: "cumpleañero", mesa: "parrales 2" },
    { name: "pacha sunset", quantity: "720", drinks: "parrales,FDC5", combos: "cascabel", mesa: "parrales 3" },
    { name: "pacha sunset", quantity: "800", drinks: "parrales,FDC5", combos: "cascabel", mesa: "parrales 4" },
    { name: "pacha sunset", quantity: "930", drinks: "parrales, fernet buhero", combos: "cumpleañero", mesa: "parrales 5" },
    { name: "pacha sunset", quantity: "450", drinks: "parrales", combos: "banx", mesa: "parrales 6" },
    { name: "pacha sunset", quantity: "930", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "parrales 7" },
    { name: "pacha sunset", quantity: "980", drinks: "parrales, gin republica", combos: "cumpleañero", mesa: "parrales 8" },
    { name: "pacha sunset", quantity: "500", drinks: "parrales", combos: "banx", mesa: "parrales 9" },
    { name: "pacha sunset", quantity: "800", drinks: "parrales,FDC5", combos: "cascabel", mesa: "parrales 10" },
    { name: "pacha sunset", quantity: "980", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "parrales 11" },
    { name: "pacha sunset", quantity: "980", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "parrales 12" },
    { name: "pacha sunset", quantity: "980", drinks: "parrales,gin republica", combos: "cumpleañero", mesa: "parrales 13" },
    { name: "pacha sunset", quantity: "980", drinks: "parrales,viuda descalza", combos: "cumpleañero", mesa: "parrales 14" },
    { name: "pacha sunset", quantity: "900", drinks: "parrales,fernet buhero", combos: "cumpleañero", mesa: "parrales 15" },
    { name: "pacha sunset", quantity: "980", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "parrales 16" },
    { name: "pacha sunset", quantity: "980", drinks: "parrales, vodka", combos: "cumpleañero", mesa: "parrales 17" },
    { name: "pacha sunset", quantity: "980", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "parrales 18" },
  ],

  cholet: [
    { name: "pacha sunset", quantity: "800", drinks: "parrales,FDC5", combos: "cascabel", mesa: "cholet 1" },
    { name: "pacha sunset", quantity: "500", drinks: "parrales", combos: "banx", mesa: "cholet 2" },
    { name: "pacha sunset", quantity: "800", drinks: "parrales,FDC5", combos: "cascabel", mesa: "cholet 3" },
    { name: "pacha sunset", quantity: "500", drinks: "parrales", combos: "banx", mesa: "cholet 4" },
    { name: "pacha sunset", quantity: "980", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "cholet 5" },
    { name: "pacha sunset", quantity: "500", drinks: "parrales", combos: "banx", mesa: "cholet 6" },
    { name: "pacha sunset", quantity: "800", drinks: "parrales,FDC5", combos: "cascabel", mesa: "cholet 7" },
    { name: "pacha sunset", quantity: "800", drinks: "parrales,FDC5", combos: "cascabel", mesa: "cholet 8" },
    { name: "pacha sunset", quantity: "500", drinks: "parrales", combos: "banx", mesa: "cholet 9" },
    { name: "pacha sunset", quantity: "980", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "cholet 10" },
    { name: "pacha sunset", quantity: "500", drinks: "parrales", combos: "banx", mesa: "cholet 11" },
    { name: "pacha sunset", quantity: "800", drinks: "parrales,FDC5", combos: "cascabel", mesa: "cholet 12" },
  ],
  ...
  extras: [
    { name: "pacha sunset", quantity: "500", drinks: "parrales", combos: "banx", mesa: "extras 1" },
    { name: "ignacio aguilar", quantity: "980", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "extras 2" },
    { name: "pacha sunset", quantity: "800", drinks: "parrales,FDC5", combos: "cascabel", mesa: "extras 3" },
    { name: "pacha sunset", quantity: "980", drinks: "parrales,FDC5", combos: "cumpleañero", mesa: "extras 4" },
    { name: "pacha sunset", quantity: "800", drinks: "parrales,FDC5", combos: "cascabel", mesa: "extras 5" },
    { name: "pacha sunset", quantity: "950", drinks: "parrales", combos: "pachamama", mesa: "extras 6" },
  ...
  Vip: [
    { name: "pacha sunset", quantity: "800", drinks: "parrales,FDC5", combos: "cascabel", mesa: "Vip 1" },
    { name: "pacha sunset", quantity: "750", drinks: "parrales,FDC5", combos: "cascabel", mesa: "Vip 2" },
    { name: "mama", quantity: "1700", drinks: "parrales", combos: "pachamama", mesa: "Vip 3" },
...
function calcularGanancias(
  ...
  const precios = {
    ...
    parrales: 65,
    "fernet branca": 120.00,
    "fernet buhero": 111.80,
    FDC5: 106,
    "gin republica": 103.4,
    jager: 210,
    cocaCola: 12.3,
...
areas.pacha
  .concat(
    ...
    areas.camel,
    areas.Vip,
    areas.extras // ✅ se añade esta línea
  )
  .forEach((sticker) => {
...
function mostrarGanancias() {
  ...
  const cocaColaCantidad = 0;
  const schweppesCantidad = 0;
  const monsterCantidad = 0; // Cantidad de Monster
  const aguaTonicaCantidad = 0; // Cantidad de Agua Tónica
  const simbaPomeloCantidad = 0; // Cantidad de Simba Pomelo
